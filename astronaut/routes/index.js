...
function buildOembedResponse(url, maxWidth, maxHeight){
  var response = {
    "version":"1.0",
    "type":"rich",
    "html": `<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/strict.dtd"> <html xmlns="http://www.w3.org/TR/xhtml1/strict" ><head><title>Shopping list</title> </head><body>
  ` + "<iframe width=\"" + maxWidth + "\" height=\"" + maxHeight + "\" src=\"" + url + "\" frameborder=\"0\" ><\/iframe></body></html>",
    "width": maxWidth,
    "height": maxHeight,
